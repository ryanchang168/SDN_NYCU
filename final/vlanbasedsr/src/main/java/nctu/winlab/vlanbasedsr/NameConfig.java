...
public class NameConfig extends Config<ApplicationId> {
    ...
    public static final String ConnectPoint_fk = "ConnectPoint";
    ...
    public boolean isValid(){
        return hasOnlyFields(VlanID, IPSubnet, ConnectPoint_fk, Mac);
    }
    ...
    public Map<Integer, String> getConnectPoint(){
        Map<Integer, String> ConnectPoint_Table = new HashMap();
        ...
        while(it.hasNext()){
            ...
            String value = Node.get(str).asText();
            ConnectPoint_Table.put(key, value);
        }
